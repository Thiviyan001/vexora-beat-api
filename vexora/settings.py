...
_default_hosts = ["localhost", "127.0.0.1", ".onrender.com", ".faable.link"]
_render_host = os.getenv("RENDER_EXTERNAL_HOSTNAME")
if _render_host: _default_hosts.append(_render_host)
...
CORS_ALLOWED_ORIGINS=[x.strip().rstrip("/") for x in FRONTEND_URL.split(",") if x.strip()] or ["http://localhost:3000","http://localhost:5173"]
